...
php app/console generate:doctrine:crud --format=annotation --with-write --overwrite --no-interaction --entity=AppBundle:CmsStzefGlobalConfiguration --route-prefix=admstzef/global_configuration;
